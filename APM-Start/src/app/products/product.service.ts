...
export class ProductService {
    ...
    getProducts(): Observable<IProduct[]> {
        if (this.products) {
            return of(this.products);  //returns an observable since getProducts is expecting an observable back
        }
        return this.http.get<IProduct[]>(this.productsUrl)
                        .pipe(
                            tap(data => console.log(JSON.stringify(data))), //tap operator allow us to tap into the observable
